...
namespace Yandex.Music.Api.Requests.Account
{
    ...
    internal class YAuthAppPasswordBuilder : YRequestBuilder<YAuthBase, string>
    {
        public YAuthAppPasswordBuilder(YandexMusicApi yandex, AuthStorage auth) : base(yandex, auth)
        {
        }
