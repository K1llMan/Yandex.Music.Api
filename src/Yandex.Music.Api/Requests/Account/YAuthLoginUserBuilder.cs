...
namespace Yandex.Music.Api.Requests.Account
{
    ...
    internal class YAuthLoginUserBuilder : YRequestBuilder<YAuthTypes, (string token, string login)>
    {
        public YAuthLoginUserBuilder(YandexMusicApi yandex, AuthStorage auth) : base(yandex, auth)
        {
        }
