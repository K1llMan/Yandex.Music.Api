...
namespace Yandex.Music.Api.Requests.Account
{
    ...
    internal class YAuthCaptchaBuilder : YRequestBuilder<Models.Account.YAuthCaptcha, string>
    {
        public YAuthCaptchaBuilder(YandexMusicApi yandex, AuthStorage auth) : base(yandex, auth)
        {
        }
