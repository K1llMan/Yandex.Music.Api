...
│   ├── LoginByQR / Async (AuthStorage storage)
│   ├── GetCaptcha / Async (AuthStorage storage)
│   ├── LoginByCaptcha / Async (AuthStorage storage, string captchaValue)
│   ├── GetAuthLetter / Async (AuthStorage storage)
│   ├── LoginByLetter / Async (AuthStorage storage)
│   ├── LoginByAppPassword / Async (AuthStorage storage, string password)
