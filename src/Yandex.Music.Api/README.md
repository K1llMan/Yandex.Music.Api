...
│   ├── ExtractStream / Async (AuthStorage storage, string trackKey, HttpCompletionOption httpCompletionOption = HttpCompletionOption.ResponseContentRead)
│   ├── ExtractStream / Async (AuthStorage storage, YTrack track, HttpCompletionOption httpCompletionOption = HttpCompletionOption.ResponseContentRead)
